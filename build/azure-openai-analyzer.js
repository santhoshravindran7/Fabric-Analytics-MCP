...
export class AzureOpenAIAnalyzer {
    ...
    async analyzeSparkLogs(logs, analysisType = 'comprehensive') {
    ...
    async analyzeStatementPerformance(statementData, analysisType = 'optimization') {
        if (!this.config.analysis.enableLLMAnalysis) {
            return "LLM analysis is disabled in configuration";
        }
    ...
    async analyzeExecutionHistory(sessions, timeRange, analysisType = 'trends') {
        if (!this.config.analysis.enableLLMAnalysis) {
            return "LLM analysis is disabled in configuration";
        }
    ...
    buildSparkAnalysisPrompt(logs, analysisType) {
...
Focus on actionable recommendations for improving Spark job performance.`;
    ...
    buildStatementAnalysisPrompt(statementData, analysisType) {
...
Focus on specific, actionable improvements for this Spark statement.`;
    ...
    buildHistoryAnalysisPrompt(sessions, timeRange, analysisType) {
...
//# sourceMappingURL=azure-openai-analyzer.js.map