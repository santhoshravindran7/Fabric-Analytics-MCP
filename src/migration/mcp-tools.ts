...
import { SynapseSource, MigrationConfig } from './types.js';
 ...
 */
export async function listSynapseWorkspaces(params: z.infer<typeof ListSynapseWorkspacesSchema>) {
 ...
 */
export async function discoverSynapseWorkspace(params: z.infer<typeof DiscoverSynapseWorkspaceSchema>) {
 ...
 */
export async function transformNotebooks(params: z.infer<typeof TransformNotebooksSchema>) {
 ...
 */
export async function migrateSynapseToFabric(params: z.infer<typeof MigrateSynapseToFabricSchema>) {
  const source: SynapseSource = {
    type: 'synapse',
    subscriptionId: params.subscriptionId,
    resourceGroup: params.resourceGroup,
 ...
 */
export async function createFabricLakehouse(params: z.infer<typeof CreateFabricLakehouseSchema>) {
 ...
 */
export async function provisionNotebooks(params: z.infer<typeof ProvisionNotebooksSchema>) {
  const { FabricProvisioner } = await import('./fabric-provisioner.js');
 ...
 */
export async function listFabricCapacities(params: z.infer<typeof ListFabricCapacitiesSchema>) {
  ...
  capacities: capacities.map((cap: any) => ({
      id: cap.id,
 ...
 */
export async function assignCapacityToWorkspace(params: z.infer<typeof AssignCapacityToWorkspaceSchema>) {
  const manager = new CapacityManager();
 ...
 */
export async function getSynapseSparkPools(params: z.infer<typeof GetSynapseSparkPoolsSchema>) {
  const manager = new SparkPoolManager();
  
  const pools = await manager.listSynapseSparkPools(
 ...
 */
export async function createFabricSparkPools(params: z.infer<typeof CreateFabricSparkPoolsSchema>) {
  const manager = new SparkPoolManager();
  
  const synapsePools = params.synapsePoolsJson ? JSON.parse(params.synapsePoolsJson) : [];
  
  const recommendations = manager.convertSynapseToFabricPools(
    synapsePools,
    params.capacitySku
  );
...
export const migrationTools = {
  ...
  fabric_synapse_workspace_details: {
    ...
    handler: async (params: z.infer<typeof SynapseWorkspaceDetailsSchema>) => {
      const orchestrator = new MigrationOrchestrator({});
  ...
  fabric_synapse_compute_spend: {
    ...
    handler: async (params: z.infer<typeof SynapseComputeSpendSchema>) => {
      const orchestrator = new MigrationOrchestrator({});
  ...
  fabric_migrate_spark_pools_to_fabric: {
    ...
    handler: async (params: z.infer<typeof MigrateSparkPoolsToFabricSchema>) => {
  ...
  fabric_recommend_fabric_capacity: {
    ...
    handler: async (params: z.infer<typeof RecommendFabricCapacitySchema>) => {
